...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1nickname","user1", "ROLE_USER");
    protected static final User USER_2 = new User(2, "user2", "user2nickname","user2", "ROLE_USER");
    private static final User USER_3 = new User(3, "user3", "user3nickname","user3", "ROLE_USER");
    ...
    public void create_user_creates_a_user() {
        User newUser = new User(-1, "new", "usernickname", "user", "ROLE_USER");
